...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-blue-950 to-black text-white">
      {/* Main Footer */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-blue-200 mb-6 leading-relaxed">
              Sistem Manajemen Pendidikan Cerdas untuk transformasi digital
              sekolah Anda. Kelola dengan mudah, efisien, dan modern.
            </p>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="bg-blue-800/30 hover:bg-blue-700 p-3 rounded-lg transition"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
        ...
        <div className="border-t border-blue-800/50 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-blue-200">
            <p>
              &copy; {currentYear} SmartEdu. All rights reserved. Made with ❤️
              in Indonesia
            </p>
